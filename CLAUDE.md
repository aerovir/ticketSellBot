...
Админ-меню строится через inline-кнопки в зависимости от роли. Все кнопки выполняют действие **напрямую** — результат показывается в том же сообщении вместо подсказки с командой.

**Super-admin видны все кнопки. Channel admin — только общие.**

| Категория | Кнопка | Что делает | Кому видна |
|-----------|--------|------------|------------|
| Статистика | 📊 Общая статистика | Показывает сводку по всем каналам/мероприятиям/билетам | Super-admin |
| | 📊 Статистика | Показывает статистику (требует ID мероприятия — вводится после) | Super-admin + admin |
...
| | ℹ️ Инфо о канале | Детальная информация (укажите @channel) | Super-admin |
| | 👥 Инфо о пользователе | Информация о пользователе (укажите user_id) | Super-admin |
| Подписки | 🟢 Подписать | Активировать подписку (@channel + days) | Super-admin |
| | 🔴 Отписать | Отключить подписку (@channel) | Super-admin |
| | 🔄 Сменить админа | Сменить владельца канала | Super-admin |
| Действия | 🎫 Создать мероприятие | Запускает FSM пошагового создания | Все админы |
| | 📋 Мои мероприятия | Список всех мероприятий канала | Все админы |
| | 🔄 Репост анонсов | Перепостить все анонсы в канал | Все админы |
| | 📢 Рассылка | Запускает FSM рассылки сообщения по каналам | Super-admin |
| | 🩺 Здоровье | Статус бота, БД, username | Super-admin |
| | ✅ Отменить билет | Отмена билета (укажите ticket_id) | Super-admin |
