...
| 212 | UI: показ политики/соглашения при первом запуске (онбординг, п.1.1.4) + ссылки на документы | 📌 pending | 2026-08-23 | — |
| 213 | Feat: удаление аккаунта и данных пользователем (п.1.1.10) | 📌 pending | 2026-08-23 | — |
| 214 | Feat: возрастные ограничения при первом запуске (п.2.1.5) | 📌 pending | 2026-08-23 | — |
